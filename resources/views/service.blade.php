...
<div class="w-full min-h-screen mt-[75px] flex">
    ...
    <div class="w-full flex flex-col m-2">
      ...
      <div class="text-center">
        <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-700 mb-4">Service</h1>
        <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-700">anda dapat memilih toko service</p>
        {{-- garis --}}
