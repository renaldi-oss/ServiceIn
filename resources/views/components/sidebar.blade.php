    ...
    <div class="h-full overflow-y-auto py-4 px-3 rounded">
      ...
      <div class="w-full h-1 bg-blue-500 rounded mt-2 mb-4"></div>
               <ul class="space-y-2">
                  ...
                  @endrole
                  <li>
                     <a href="{{ route('transaction') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
