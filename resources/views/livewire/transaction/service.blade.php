            ...
            <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                >
                    ...
                    <form wire:submit.prevent="createTransaction">
                        {{ $this->form }}
                        <button type="submit" class="flex items-center justify-center mt-3 px-3 py-2 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-500 rounded-md dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:bg-blue-700 hover:bg-blue-600 focus:outline-none focus:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                            <span>Create Transaction</span>
                        </button>
                    </form>
                </div>
