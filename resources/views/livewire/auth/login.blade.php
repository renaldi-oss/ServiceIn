            ...
            <form wire:submit.prevent="authenticate">
                ...
                <div class="mt-6">
                    <span class="block w-full rounded-md shadow-sm">
                        <button id="btn" type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:ring-indigo active:bg-indigo-800 transition duration-150 ease-in-out">
                            Sign in
                        </button>
                    </span>
                </div>
