    ...
    <div class="flex flex-col justify-center min-h-screen py-12 bg-gray-50 sm:px-6 lg:px-8">
        <x-navbar />
          ...
          <section class="mb-32 text-gray-800 text-center">
            <h2 class="text-3xl font-bold mb-32">About <u class="text-blue-600">Us</u></h2>
            ...
            <div class="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
                ...
                <div class="rounded-lg shadow-lg h-full block bg-white">
                  <div class="flex justify-center">
                    <div class="flex justify-center" style="margin-top: -75px">
                      <img src="assets/images/sadboi.png"  class="rounded-full mx-auto shadow-lg" alt=""
                        style="width: 150px" />
                    </div>
                  </div>
                  <div class="p-6">
                    <h5 class="text-lg font-bold mb-4">Clara Adriana Sidauruk</h5>
                    <p class="mb-6">Project Manajer</p>
              ...
              <div class="mb-24 md:mb-0">
                <div class="rounded-lg shadow-lg h-full block bg-white">
                  ...
                  <div class="p-6">
                    <h5 class="text-lg font-bold mb-4">Haarisah Yustika Putri Al-Jufri</h5>
                    <p class="mb-6">UI/UX Designer</p>
                    <ul class="list-inside flex mx-auto justify-center">
                      <a href="#!" class="px-2">
              ...
              <div class="">
                <div class="rounded-lg shadow-lg h-full block bg-white">
                  ...
                  <div class="p-6">
                    <h5 class="text-lg font-bold mb-4">Reynaldi Fakhri Pratama</h5>
                    <p class="mb-6">Programmer</p>
                    <ul class="list-inside flex mx-auto justify-center">
                      <a href="#!" class="px-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 text-blue-600">
                          <path fill="currentColor"
